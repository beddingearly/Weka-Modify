...
/**
 * Implement C45m1 classifier.
 */
public class C45m1 extends Classifier {

    /** The node's successors.
     * 保存决策树节点的数组 */
    private weka.classifiers.wztong.C45m1[] m_Successors;
    ...
    /**
     * Builds C45m1 decision tree classifier.
     *
    ...
    public weka.classifiers.wztong.C45m1[] getSuccessors(){
        return m_Successors;
    }
    ...
    /**
     * Method building C45m1 tree using information gain measure
     * need to modify
     * @param data the training data
    ...
    private void makeTree(Instances data) throws Exception {
        ...
        for (int i = 0; i < data.numAttributes(); i++){
            ...
            // 计算每一列的信息熵
            impurityReduce = computeInfoGainRadio(data, data.attribute(i));
...
//        System.out.println(maxValue);
        ...
        if(Utils.eq(maxValue, 0)){
            ...
            m_Successors = new weka.classifiers.wztong.C45m1[m_Attribute.numValues()];
            for (int j = 0; j < m_Attribute.numValues(); j++) {
                m_Successors[j] = new weka.classifiers.wztong.C45m1();
...
//            System.out.println(a);
    ...
    private double computeInfoGainRadio(Instances data, Attribute att) throws Exception{
        ...
        double InfoGainRadio = infoGain / IVa;
        return InfoGainRadio;
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            System.out.println(Evaluation.evaluateModel(new weka.classifiers.wztong.C45m1(), args));
        } catch (Exception e) {
